# Ansible Operation - F5 BIGIP

The following is a collection of playbooks to help an organization automate OPS with F5.

The following inventory file is locatec int /ops/inventory/


To execute use the following
```
ansible-playbook -i /Users/sebbycorp/Documents/Projects/f5-projects/f5-ansible-deployments/ops/inventory/hosts bigip-info.yml
```
